...
async function enviarSolicitud() {
  ...
  else if (!CARNET_RE.test(carnet)) { showErr(document.getElementById('errCarnet'), 'El carné debe tener 6 dígitos (ej. 170964).'); ok = false; }
